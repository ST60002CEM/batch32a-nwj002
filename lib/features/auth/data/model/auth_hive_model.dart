...
class AuthHiveModel {
  ...
  List<AuthEntity> toEntityList(List<AuthHiveModel> hiveModels) =>
      hiveModels.map((hiveModel) => hiveModel.toEntity()).toList();
  ...
  @override
  String toString() {
    return 'userId: $userId, fullname: $fullname, username: $username, age: $age, email: $email, password: $password,';
  }
}
